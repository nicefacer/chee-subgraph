...
export function exponentToBigDecimal(decimals: BigInt): BigDecimal {
  let bd = BigDecimal.fromString('1')
  for (let i = BigInt.fromI32(0); i < decimals; i = i.plus(BigInt.fromI32(1))) {
    bd = bd.times(BigDecimal.fromString('10'))
  }
  return bd
}
...
export let mantissaFactorBD: BigDecimal = exponentToBigDecimal(BigInt.fromI32(18))
export let cTokenDecimalsBD: BigDecimal = exponentToBigDecimal(BigInt.fromI32(8))
